...
hash_scheme_and_function_mode=(PROBELINEARMODEL PROBELINEARMODEL) #(PROBETRADITIONAL PROBETRADITIONAL PROBETRADITIONAL PROBETRADITIONAL CHAINLINEARMODEL CHAINLINEARMODEL CHAINLINEARMODEL CHAINTRADITIONAL CHAINTRADITIONAL CHAINTRADITIONAL CHAINTRADITIONAL) #(0)
...
hash_scheme_and_function_mode=(PROBETRADITIONAL PROBETRADITIONAL PROBETRADITIONAL PROBETRADITIONAL) #(CHAINLINEARMODEL CHAINLINEARMODEL CHAINLINEARMODEL CHAINTRADITIONAL CHAINTRADITIONAL CHAINTRADITIONAL CHAINTRADITIONAL) #(0)
