...
hash_scheme_and_function_mode=(CHAINEXOTIC) #(CUCKOOLINEARMODEL CUCKOOLINEARMODEL CUCKOOTRADITIONAL CUCKOOTRADITIONAL CUCKOOTRADITIONAL CUCKOOTRADITIONAL PROBELINEARMODEL PROBELINEARMODEL PROBETRADITIONAL PROBETRADITIONAL PROBETRADITIONAL PROBETRADITIONAL CHAINLINEARMODEL CHAINLINEARMODEL CHAINLINEARMODEL CHAINTRADITIONAL CHAINTRADITIONAL CHAINTRADITIONAL CHAINTRADITIONAL) #(0)
hash_fun=(MWHC) #(MURMUR XXHASH3 AQUA MULTPRIME)
hash_overalloc=(10 10 10 10 10 10 10 10 10 10 10 10)
