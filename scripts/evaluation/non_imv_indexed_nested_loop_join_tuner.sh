...
hash_scheme_and_function_mode=(CHAINLINEARMODEL CHAINLINEARMODEL CHAINLINEARMODEL CHAINLINEARMODEL CHAINLINEARMODEL CHAINLINEARMODEL CHAINLINEARMODEL CHAINLINEARMODEL CHAINLINEARMODEL CHAINLINEARMODEL) #(CHAINEXOTIC CUCKOOLINEARMODEL CUCKOOLINEARMODEL CUCKOOTRADITIONAL CUCKOOTRADITIONAL CUCKOOTRADITIONAL CUCKOOTRADITIONAL PROBETRADITIONAL PROBETRADITIONAL PROBETRADITIONAL PROBETRADITIONAL CHAINLINEARMODEL CHAINLINEARMODEL CHAINLINEARMODEL CHAINTRADITIONAL CHAINTRADITIONAL CHAINTRADITIONAL CHAINTRADITIONAL) #(0)
