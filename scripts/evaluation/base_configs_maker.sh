...
usage()
{
  echo "Usage: sh base_configs_maker.sh [ --INTEL_E5 0] [ --INTEL_XEON 1] [ --MAX_CPU_NODES 512] [ --HAVE_LIBNUMA  1]
                        ...
                        [ --RELATION_R_PATH /spinning/sabek/learned_join_datasets/r_UNIQUE_v1_uint32_uint32_16000000.txt] [ --RELATION_R_FOLDER_PATH /spinning/sabek/learned_join_datasets/] [ --RELATION_R_FILE_NAME r_UNIQUE_v1_uint32_uint32_16000000] [ --RELATION_R_FILE_EXTENSION .txt] [ --RELATION_R_NUM_TUPLES 16E6]
                        [ --RELATION_S_PATH /spinning/sabek/learned_join_datasets/s_UNIQUE_v1_uint32_uint32_16000000.txt] [ --RELATION_S_FOLDER_PATH /spinning/sabek/learned_join_datasets/] [ --RELATION_S_FILE_NAME s_UNIQUE_v1_uint32_uint32_16000000] [ --RELATION_S_FILE_EXTENSION .txt] [ --RELATION_S_NUM_TUPLES 16E6]
                        ...
                        [ --INLJ_WITH_HASH_INDEX 1] [ --INLJ_WITH_LEARNED_INDEX 0] [ --INLJ_WITH_CSS_TREE_INDEX 0] [ --INLJ_WITH_ART32_TREE_INDEX 0] [ --INLJ_WITH_ART64_TREE_INDEX 0]
