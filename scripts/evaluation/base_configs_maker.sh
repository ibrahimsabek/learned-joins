...
usage()
{
  echo "Usage: sh base_configs_maker.sh [ --INTEL_E5 0] [ --INTEL_XEON 1] [ --MAX_CPU_NODES 512] [ --HAVE_LIBNUMA  1]
                        ...
                        [ --INLJ_WITH_HASH_INDEX 1] [ --INLJ_WITH_LEARNED_INDEX 0] [ --INLJ_WITH_LEARNED_INDEX_MODEL_BASED_BUILD 0] [ --INLJ_WITH_CSS_TREE_INDEX 0] [ --INLJ_WITH_ART32_TREE_INDEX 0] [ --INLJ_WITH_ART64_TREE_INDEX 0]
