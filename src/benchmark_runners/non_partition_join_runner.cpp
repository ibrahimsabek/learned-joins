...
{   
    ...
    for(i=0; i < rel_r_partition->num_tuples; i++)
    {
        ...
        if( (rel_r_partition->tuples[i].key == 368)|| (rel_r_partition->tuples[i].key == 192) || (rel_r_partition->tuples[i].key == 175)||(rel_r_partition->tuples[i].key >70 && rel_r_partition->tuples[i].key < 80))
        {
